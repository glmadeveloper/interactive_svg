...
export const ICAD: IcadCommunityObject = {
    ...
    data: {
        alReem: {
            ...
            properties: [
                { title: "Capacity", value: "1,638 Staff" },
                { title: "Buildings", value: "8 Buildings" },
                { title: "Unit Type", value: "5x1 - 66 m2" },
                { title: "Floors", value: "Multi-Floor Residential Buildings" }
            ],
            images: [icad_al_reem_5_beds_image]
        },

        alMesk: {
            title: "AL MESK – STAFF ACCOMMODATION",
            description: "Large residential complex with multiple unit configurations designed to support varied occupancy levels and flexible accommodation needs.",
            category_name: "BUILDING OVERVIEW",
            properties: [
                { title: "Capacity", value: "12,609 Staff" },
                { title: "Buildings", value: "9 Buildings" },
                { title: "Unit Type", value: "5x1, 4x1, 10x1" },
                { title: "Floors", value: "Multi-Floor Residential Buildings" }
            ],
            images: [
                icad_al_mesk_s3_studio_5_beds_image,
        ...
        icadMall: {
            ...
            properties: [
                { title: "Type", value: "Commercial Facility" },
                { title: "Quantity", value: "1 Building" },
                { title: "Function", value: "Retail and Community Services" },
        ...
        sportsHall: {
            title: "SPORT HALL",
            description: "Indoor sports and activity facility designed to support fitness, recreation, and group activities for residents.",
            category_name: "FACILITY OVERVIEW",
            properties: [
                { title: "Type", value: "Recreational Facility" },
                { title: "Quantity", value: "1 Building" },
                { title: "Function", value: "Sports and Physical Activities" },
                { title: "Access", value: "Central Location" }
            ],
        ...
        alNaseem: {
            ...
            category_name: "BUILDING OVERVIEW",
            properties: [
                { title: "Capacity", value: "11,502 Staff" },
                { title: "Buildings", value: "9 Buildings" },
                { title: "Unit Type", value: "Mixed Flat Types (1x1–1x3) 71m2" },
                { title: "Floors", value: "Multi-Floor Residential Buildings" }
            ],
        ...
        alSahab1: {
            ...
            category_name: "BUILDING OVERVIEW",
            properties: [
                { title: "Capacity", value: "1,152 Staff" },
                { title: "Buildings", value: "8 Buildings" },
                { title: "Unit Type", value: "1x3 - 66 m2" },
                { title: "Floors", value: "Multi-Floor Residential Buildings" }
            ],
        ...
        alDhabi1: {
            ...
            category_name: "BUILDING OVERVIEW",
            properties: [
                { title: "Capacity", value: "13,320 Staff" },
                { title: "Buildings", value: "18 Buildings" },
                { title: "Room Types", value: "5x1 - 66 m2" },
                { title: "Floors", value: "Multi-Floor Residential Buildings" }
            ],
        ...
        alYass1: {
            ...
            category_name: "BUILDING OVERVIEW",
            properties: [
                { title: "Capacity", value: "15,416 Staff" },
                { title: "Buildings", value: "9 Buildings" },
                { title: "Unit Type", value: "Mixed Flat Types (6x1–10x1)" },
                { title: "Floors", value: "Multi-Floor Residential Buildings" }
            ],
        ...
        alMurjan: {
            ...
            category_name: "BUILDING OVERVIEW",
            properties: [
                { title: "Capacity", value: "1,440 Staff" },
                { title: "Buildings", value: "12 Buildings" },
                { title: "Unit Type", value: "3x1-66 m2, 4x1-66 m2" },
                { title: "Floors", value: "Multi-Floor Residential Buildings" }
            ],
            images: [
                icad_al_murjan_bed_room_studio_3_pax_image,
