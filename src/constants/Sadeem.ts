...
export const SADEEM: SadeemCommunityObject = {
    ...
    data: {
        administration: {
            ...
            properties: [
                { title: "Type", value: "Administrative Facility" },
        ...
        clinic: {
            ...
            properties: [
                ...
                { title: "Quantity", value: "1 Building" },
                { title: "Function", value: "Medical Consultation and First Aid" },
        ...
        commercialShops: {
            ...
            description: "On-site retail facility providing daily essentials and convenience services for residents. Supports basic needs within walking distance.",
            category_name: "FACILITY OVERVIEW",
            properties: [
        ...
        kitchen_and_dining: {
            ...
            properties: [
                ...
                { title: "Quantity", value: "2 Kitchen & Dining Blocks + 2 Dining Halls" },
        ...
        mosque: {
            ...
            properties: [
                ...
                { title: "Access", value: "Centrally Positioned for All Clusters" }
            ],
        ...
        type_B_2_buildings: {
            ...
            properties: [
                { title: "Capacity", value: "2,616 Staff" },
                { title: "Buildings", value: "2 Buildings" },
                { title: "Room Types", value: "4x1 / 6x1 / 10x1" },
                { title: "Floors", value: "G+2 Residential Buildings" }
            ],
            images: [razeen_sadeem_aryam_sadeem_4_image]
        },
        ...
        type_D_8_buildings: {
            ...
            category_name: "BUILDING OVERVIEW",
            properties: [
                { title: "Capacity", value: "5,232 Staff" },
        ...
        type_A_10_buildings: {
            ...
            category_name: "BUILDING OVERVIEW",
            properties: [
                { title: "Capacity", value: "17,880 Staff" },
                { title: "Buildings", value: "10 Buildings" },
                { title: "Room Types", value: "4x1 / 6x1 / 10x1" },
                { title: "Floors", value: "G+2 Residential Buildings" }
            ],
